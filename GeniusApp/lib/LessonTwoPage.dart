...
class LessonTwoPage extends StatefulWidget{
  @override
  _LessonTwoPage createState() => _LessonTwoPage();
...
class _LessonTwoPage extends State<LessonTwoPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      ListView(
        children: <Widget>[
          _ButterFlyAssetVideo(videoUrl[0]),
          _ButterFlyAssetVideo(videoUrl[1]),
          Expanded(
            child:Column(
