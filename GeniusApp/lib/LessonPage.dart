...
class _LessonPage extends State<LessonPage> {
  ...
  void initState() {
    ...
    BannerAd(
      ...
      BannerAdListener(
        onAdLoaded: (ad) {
          setState(() {
            _mediumBannerAd2 = ad as BannerAd;
          });
        },
        onAdFailedToLoad: (ad, err) {
          print('Failed to load a banner ad: ${err.message}');
  ...
  void updateUserPoints(int points) async {
    ...
    User user = new User.withId(
        userAccountController.userId, userAccountController.username,
        userAccountController.level, userAccountController.points);
  ...
  Widget build(BuildContext context) {
    QuizController quizController = Get.put(QuizController());
    UserAccountController userAccountController = Get.put(
      ...
      FutureBuilder(
        ...
        builder: (BuildContext ctx, AsyncSnapshot snapshot) {
          ...
          if (snapshot.data == null) {
            ...
            else if (quizController.score >= 9 && quizController.score <= 12) {
              newPoints = 3;
            }
            else if (quizController.score >= 13 && quizController.score <= 16) {
              newPoints = 4;
            }
            else if (quizController.score >= 17 && quizController.score <= 20) {
              newPoints = 5;
            }
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                            ...
                            Image.network(config.imageURL + snapshot.data[0]
                                .image,
                          ...
                          children: <Widget>[
                            ElevatedButton(
                              ...
                              onPressed: () async {
                                ...
                                quizController.previousQuizIds.add(
                                    snapshot.data[0].id);
                                final player = AudioPlayer();
                                player.setAsset(snapshot.data[0].optionA == snapshot.data[0].answer?"assets/sounds/correct.mp3":"assets/sounds/wrong.mp3");
                                player.play();
                            ...
                            ElevatedButton(
                              ...
                              onPressed: () {
                                ...
                                quizController.previousQuizIds.add(
                                    snapshot.data[0].id);
                                final player = AudioPlayer();
                                player.setAsset(snapshot.data[0].optionB == snapshot.data[0].answer?"assets/sounds/correct.mp3":"assets/sounds/wrong.mp3");
                                player.play();
                            ...
                            ElevatedButton(
                              ...
                              onPressed: () {
                                ...
                                quizController.previousQuizIds.add(
                                    snapshot.data[0].id);
                                final player = AudioPlayer();
                                player.setAsset(snapshot.data[0].optionC == snapshot.data[0].answer?"assets/sounds/correct.mp3":"assets/sounds/wrong.mp3");
                                player.play();
                            ...
                            ElevatedButton(
                              ...
                              onPressed: () {
                                ...
                                quizController.previousQuizIds.add(
                                    snapshot.data[0].id);
                                final player = AudioPlayer();
                                player.setAsset(snapshot.data[0].optionD == snapshot.data[0].answer?"assets/sounds/correct.mp3":"assets/sounds/wrong.mp3");
                                player.play();
  ...
  void _showRewardedAd() {
    ...
    _rewardedAd.show(
        onUserEarnedReward: (AdWithoutView ad, RewardItem reward) {
          ...
          updateUserPoints(1);
          _showAlertDialog("1 point awarded", "Your earned points will reflect on home page");
        });
    _rewardedAd = null;
  }
